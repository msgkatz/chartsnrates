...
import com.msgkatz.ratesapp.presentation.ui.quoteasset.navigateToQuoteAsset2
...
class CnrAppState(
    ...
    val currentTopLevelDestination: CnrTopLevelDestination?
        @Composable get() = tabList.collectAsState().value.filter {
            currentDestination?.route.equals(it.route)
        }.firstOrNull()
