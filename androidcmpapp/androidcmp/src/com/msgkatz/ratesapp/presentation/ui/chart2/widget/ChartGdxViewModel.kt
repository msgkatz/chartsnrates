...
import com.msgkatz.ratesapp.presentation.ui.chart2.gdx.common.ChartGdxGame
import com.msgkatz.ratesapp.presentation.ui.chart2.gdx.prerenderer.Controller
...
class ChartGdxViewModel @Inject constructor(
    ...
    companion object {
        val TAG: String = "ChartGdxViewModel2" //ChartGdxViewModel::class.java.simpleName
    }
