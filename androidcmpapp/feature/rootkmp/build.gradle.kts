...
group = "com.msgkatz.ratesapp.feature.rootkmp"
version = "1.0"
...
kotlin {
    ...
    js {
        browser {
            webpackTask {
                mainOutputFileName = "cnr-root-kmp.js"
            }
        }
        binaries.executable()
    }
...
//            implementation(project(":androidcmpapp:feature:splashkmp"))
            implementation(project(":androidcmpapp:data:cnr-model-kmm"))


//            implementation(project(":androidcmpapp:feature:quoteassetkmp"))
//            implementation(project(":androidcmpapp:data:cnr-model-kmm"))
