...
fun CnrNavigationPreview() {
    ...
    val icons = listOf(
        painterResource(resource = Res.drawable.cur_usdt),
        painterResource(resource = Res.drawable.cur_bnb),
        painterResource(resource = Res.drawable.cur_btc),
        painterResource(resource = Res.drawable.cur_eth),
    )
