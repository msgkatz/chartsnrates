...
group = "com.msgkatz.ratesapp.feature.splashkmp"
version = "1.0"
...
kotlin {
    ...
    js {
        browser {
            webpackTask {
                mainOutputFileName = "cnr-splash-kmp.js"
            }
        }
        binaries.executable()
    }
...
android {
    namespace = "com.msgkatz.ratesapp.feature.splashkmp"
    compileSdk = 35
